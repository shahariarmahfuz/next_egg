...
export function Header() {
  return (
    <header className="sticky top-0 z-30 flex h-16 shrink-0 w-full items-center justify-between border-b border-border bg-card/80 dark:bg-card/70 px-4 md:px-6 backdrop-blur-md text-card-foreground print:hidden">
